...
<body>
		...
		<input type="text" name="name" value="{{$item->username}}"><br>
		<label for="usn">USN</label>
		<input type="number" name="usn" value="{{$item->usn}}"><br>
		...
		<input type="text" name="address" value="{{$item->address}}"><br>
		<label for="email">E-mail</label>
		<input type="email" name="email" value="{{$item->address}}"><br>
		<label for="ca">Classes Attended</label>
		<input type="number" name="ca" value="{{$item->ca}}"><br>
		<label for="tch">Total Classes Held</label>
		<input type="number" name="tch" value="{{$item->tch}}"><br>
		@endforeach
...
<body>
	...
	<form method="post" action="/edit">
		...
		<label for="address">Address</label>
		<!-- <input type="text" name="address" class="form-control" placeholder="Enter the address"><br> -->
